...
/**
 * Abstract interface of the Catalog database.
 ...
 *
 * This abstraction allows the implementators
 * to change the source and specifics about the
 * the data sources without changing the
 * interface of the catalog data access. Allows
